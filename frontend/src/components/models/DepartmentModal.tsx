...
import { DepartmentDetail, RoleDetail } from '@services/securityApi';
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {mode === 'create' ? 'Create a new department with assigned roles' :
                   mode === 'edit' ? 'Modify department information and roles' :
