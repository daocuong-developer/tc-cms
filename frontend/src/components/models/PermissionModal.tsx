            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900">
                  {mode === 'create' ? 'Create New Permission' : 
                   mode === 'edit' ? 'Edit Permission' : 'Permission Details'}
                </h2>
                <p className="text-sm text-gray-600">
                  {mode === 'create' ? 'Define a new permission for the system' :
                   mode === 'edit' ? 'Modify permission information' :
            ...
            <div className="bg-gray-50 rounded-lg p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {formData.type && (
                    <div className="mt-2">
                      <span className={`px-2 py-1 text-xs font-medium rounded-full ${getPermissionTypeBadge(formData.type)}`}>
        ...
        <div className="bg-gray-50 border-t border-gray-200 px-6 py-4 flex justify-end space-x-3">
          ...
          {mode !== 'view' && (
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white bg-orange-600 border border-transparent rounded-lg hover:bg-orange-700 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
            >
              {loading ? (
                <>
